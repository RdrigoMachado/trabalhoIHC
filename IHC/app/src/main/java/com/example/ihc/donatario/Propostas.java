...
public class Propostas extends AppCompatActivity {

    private ArrayList<Doacao> doacoes;
    private PropostasAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listaDoacaoesAndamentos = (ListView) findViewById(R.id.listaDoacaoesPropostas);
        adapter = new PropostasAdapter(this, doacoes);
    ...
    private void carregaDadosEAtualizaLista(){
        String url = "https://www.ufrgs.br/museudeinformatica/ihc/paginas/listar_doacoes_espera.php";

        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(com.example.ihc.donatario.Propostas.this);
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(com.example.ihc.donatario.Propostas.this, "Fail to get course" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
