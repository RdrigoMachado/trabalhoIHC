...
public class AndamentoAdapter  extends BaseAdapter {
    ...
    public AndamentoAdapter(Context c, ArrayList<Doacao> doacoes) {
        this.c = c;
    ...
    private void abrirJanelaInfo(Doacao doacao, Doador doador, int posicao){
        ...
        LayoutInflater layoutinflater = LayoutInflater.from(c);
        View promptUserView = layoutinflater.inflate(R.layout.info_doacao_donatario, null);
        ...
        Button btReceber = (Button) promptUserView.findViewById(R.id.btReceber);
        btReceber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mudarStatus(doacao.getId(), "2", posicao);
                alertDialog.cancel();
            }
        });
